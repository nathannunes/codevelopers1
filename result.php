<?php
    ...
    if(isset($_GET['com']))
    {
        ...
        else if($comment === 'profile update successful')
        {
            $commentable = "PROFILE UPDATED SUCCESSFULLY !";
        }
        ...
        else if($comment === 'feed submission successful')
        {
            $commentable = "FEEDBACK SUBMISSION SUCCESSFUL.<br><br> THANKS FOR YOUR TIME.";
        }
    }
