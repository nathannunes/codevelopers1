...
{   
	...
	else
	{
		...
		else
		{
			...
			$query2 = "INSERT INTO profiles(roll_no,first_name,last_name,role,gender)VALUES('$roll_no','$first_name','$last_name','$role','$gender')";
			  // echo($query2);
			...
			if($result1 && $result2)
			{
				...
				$act_url = "https://codevelopers.000webhostapp.com/activation.php?rn=$roll_no&".$act_id;
				//echo($act_url);
